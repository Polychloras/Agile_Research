...
\begin{itemize}
\item RQ1: How do the technologies used to track milestones and foster communication during software devolpment impact the Agile Process?

\item RQ2: What effect do these technologies have on the turnaround time of software built using the agile development process?

\item RQ3: How did the adoption rate of remote tools during the pandemic affect existing agile methods?
\end{itemize}
